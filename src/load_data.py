...
data_files = {
    "train": "dataset_new/train_data.json",
    "validation": "dataset_new/dev_data.json",
    "test": "dataset_new/test_data.json"
}
# test_datasets = datasets.load_dataset("json", data_files="dataset_new/test_data.json", split="train")
full_dataset = datasets.load_dataset("json", data_files=data_files)
# user_id, weibo_id, text, humor_level
